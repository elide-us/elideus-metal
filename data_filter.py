...
async def operations_callback(app: FastAPI, op: defaultdict) -> None:
  posts_to_create = []
  posts_to_delete = []

  for created_post in op[models.ids.AppBskyFeedPost]['created']:
  ...
  deleted_posts = op[models.ids.AppBskyFeedPost]['deleted']
